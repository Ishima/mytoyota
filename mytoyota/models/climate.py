...
from ..models.endpoints.climate import (
    ClimateStatusModel,
    ClimateOptions,
...
class ClimateOptionStatus:
    def __init__(
        ...
        Args:
        ----
            climate_option_status (ClimateOptions, optional): Contains all options of climate
...
class ClimateStatus:
    def __init__(
        ...
        Args:
        ----
            climate_status (ClimateStatusModel, required): Contains all information regarding the climate status
...
class ClimateSettingsOperation:
    def __init__(
        ...
        Args:
        ----
            operations (ACOperations, optional): Contains all options of climate
...
class ClimateSettings:
    def __init__(
        ...
        Args:
        ----
            climate_settings (ClimateSettingsModel, required): Contains all information regarding the climate settings
    ...
    def temp_interval(self) -> float | None:
        ...
        Returns
        -------
            float | None: The value of temp interval
    ...
    def min_temp(self) -> float | None:
        ...
        Returns
        -------
            float | None: The value of min temp
    ...
    def max_temp(self) -> float | None:
        ...
        Returns
        -------
            float | None: The value of max temp
